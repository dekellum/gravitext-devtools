=== 1.3.0 (2012-9-13)
* Add gt-version script for aiding common version bump,date tasks.
* Fix gt-header usage text
* Ruby 1.9/charset relates fixes
...
=== 1.0.1 (2010-8-1)
* Include missing rainbow dependency.
